...
query  {
    allStrapiWine(filter: {staffPicks: {eq: true}}) {
    nodes {
      title
      slug
      image {
  ...
  }  allStrapiLiquor (filter: {staffPicks: {eq: true}}) {
    nodes {
      title
      slug
      image {
...
export const Head = ({ data }) => <title>Staff Picks - Blue Rock Liquor, Wine & Spirits</title>
